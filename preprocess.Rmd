...
# older adults
data.raw = read.csv("MDM_R&A_Task_withGraphics_COVID-19_May+8,+2020_11.30.csv")
...
is.element(colnames(data.young), colnames(data.old))
is.element(colnames(data.old), colnames(data.young))
...
# save 
save(data.all, file = "data_all_444sub.Rda")
```
