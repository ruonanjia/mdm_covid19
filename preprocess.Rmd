...
launch <- data.frame(start=as.Date(c("2020-03-29", "2020-04-06")), 
                     end=as.Date(c("2020-03-31", "2020-04-07")))
...
colnames(data.raw)[col.no]
att.check <- data.raw[, col.no]
...
ggplot(geo,aes(longitude,latitude)) +
  ...
  geom_point(aes(color = count),size=1,alpha=1) + 
