...
fit.choice <- ulam(
  alist(
    choice ~ dbern(1, choice_prob), # sample from bernoulli distribution
    ...
    uR <- (prob.ref - beta[id] * (ambig.ref/2)) * val.ref ^alpha[id], # subjective value of the reference
  ...
  data = data.choice.mon, iter = 5e4, chains=4, cores = 2
)
```
