...
data_list <- list(
  choice = data.choice.mon$choice[1:490],
  prob = data.choice.mon$prob[1:490],
  ambig = data.choice.mon$ambig[1:490],
  val = data.choice.mon$val[1:490],
  prob_ref = data.choice.mon$prob.ref[1:490],
  ambig_ref = data.choice.mon$ambig.ref[1:490],
  val_ref = data.choice.mon$val.ref[1:490],
  id = data.choice.mon$subid[1:490]
)
...
fit.choice.multi <- ulam(
  ...
  # start=list(alpha=.5, beta=0, sigma=1)
  start = list(alpha = rep(0.5, 10), beta = rep(0.2, 10), sigma = rep(-1, 10))
)
