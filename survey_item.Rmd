...
# ambig_score$ambig1_react_nation <- as.integer(as.character(ambig_score$ambig1_react_nation))
# ambig_score$ambig1_react_state <- as.integer(as.character(ambig_score$ambig1_react_state))
# ambig_score$ambig1_react_science <- as.integer(as.character(ambig_score$ambig1_react_science))
# ambig_score$ambig1_react_worker <- as.integer(as.character(ambig_score$ambig1_react_worker))
# ambig_score$ambig1_react_econ <- as.integer(as.character(ambig_score$ambig1_react_econ))
# ambig_score$ambig1_react_you <- as.integer(as.character(ambig_score$ambig1_react_you))


# ambig_score$ambig2_health_impact <- as.integer(as.character(ambig_score$ambig2_health_impact))
# ambig_score$ambig2_economics <- as.integer(as.character(ambig_score$ambig2_economics))
...
array2pca <- array2pca[!is.na(rowSums(array2pca_raw)),]
...
## general code
Need to specify which component and which uncertainty attitude
```{r}
pc2plot = 'PC2'
