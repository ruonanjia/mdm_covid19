...
7-Definitely
```{r}
data.all.phase2$vacc_willing <- as.factor(as.character(data.all.phase2$vacc_willing))
...
```{r}
data.all.phase2$vacc_effect <- as.factor(as.character(data.all.phase2$vacc_effect))
...
```{r}
data.all.phase2$vacc_effect_conf <- as.factor(as.character(data.all.phase2$vacc_effect_conf))
...
7-Extremely safe
```{r}
data.all.phase2$vacc_safe <- as.factor(as.character(data.all.phase2$vacc_safe))
...
7-Absolutely confident
```{r}
data.all.phase2$vacc_safe_conf <- as.factor(as.character(data.all.phase2$vacc_safe_conf))
